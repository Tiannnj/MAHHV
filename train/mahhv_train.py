...
def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            ...
            #
            from envs.mahhv_env_discrete import MahhvDiscreteActionEnv
            #
            env = MahhvDiscreteActionEnv()
    ...
    return MAHHVEnv([get_env_fn(i) for i in range(all_args.n_rollout_threads)])
